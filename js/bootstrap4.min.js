...
!(function(t, e) {
	...
	function R(t) {
		...
		return i && 'BODY' !== i && 'HTML' !== i
			? -1 !== [ 'TH', 'TD', 'TABLE' ].indexOf(n.nodeName) && 'static' === A(n, 'position') ? R(n) : n
				...
				computeStyle: {
					...
					fn: function(t, e) {
						...
						if (
							((m =
								'bottom' === h
									? 'HTML' === a.nodeName ? -a.clientHeight + u.bottom : -l.height + u.bottom
									: u.top),
							(p =
								'right' === f
									? 'HTML' === a.nodeName ? -a.clientWidth + u.right : -l.width + u.right
									: u.left),
							s && d)
						)
					...
					'object' != typeof n || (!n.nodeType && !n.jquery)
						? this.config.html
							? (this.config.sanitize && (n = Vt(n, this.config.whiteList, this.config.sanitizeFn)),
								t.html(n))
							: t.text(n)
						: this.config.html ? e(n).parent().is(t) || t.empty().append(n) : t.text(e(n).text());
				}),
				(n.getTitle = function() {
